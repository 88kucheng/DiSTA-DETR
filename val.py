...
if __name__ == '__main__':
    ...
    if model.task == 'detect':
        ...
        model_info_table.field_names = ["GFLOPs", "Parameters", "Preprocessing time per image", "Inference time per image", "Postprocessing time per image", "FPS", "FPS(Inference)", "Model File Size"]
